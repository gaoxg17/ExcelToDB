...
namespace ExcelToDB.Lib
{
    ...
    public class Filed
    {
        ...
        [XmlAttribute]
        public string FldName { get => _fldName; set => _fldName = value; }        
        [XmlAttribute]
        public string FldType { get => _fldType; set => _fldType = value; }
        [XmlAttribute]
        ...
        /// <returns></returns>
        public Filed FromXml(string Xml)
        {
            ...
            try
            {
                ...
                obj = (Filed)ser.Deserialize(xmlReader);
            }
            catch (Exception ex)
            {
        ...
        public Filed fromXmlFile(string xmlFileName)
        {
            Stream reader = null;
            Filed obj = new Filed();
            try
            {
                XmlSerializer serializer = new XmlSerializer(typeof(Filed));
                reader = new FileStream(xmlFileName, FileMode.Open);
                obj = (Filed)serializer.Deserialize(reader);
                reader.Close();
            }
            catch (Exception ex)
            {
